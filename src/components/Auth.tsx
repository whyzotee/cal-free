        ...
        <form onSubmit={handleAuth} className="space-y-4">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full pl-14 pr-6 py-5 bg-zinc-50 border-none rounded-[32px] focus:ring-4 focus:ring-purple-100 focus:bg-white transition-all font-medium text-zinc-900 placeholder:text-zinc-300"
              required
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-5 bg-zinc-900 text-white font-black rounded-[32px] shadow-xl shadow-zinc-200 active:scale-95 transition-all flex items-center justify-center gap-3 uppercase text-xs tracking-widest mt-4 disabled:opacity-50"
          >
            {loading ? (
        ...
        <div className="mt-8 text-center space-y-4">
          {!isForgotPassword && !isSignUp && (
            <button
              ...
              className="text-[10px] text-zinc-400 font-black uppercase tracking-widest hover:text-purple-600 transition-colors block mx-auto"
            >
              Forgot Password?
            </button>
          )}
