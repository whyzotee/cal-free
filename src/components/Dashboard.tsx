...
import { Utensils, ChevronRight, Plus, Info } from "lucide-react";
    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-52 h-52 flex items-center justify-center mb-8">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pt-2">
                ...
                <p className="text-zinc-500 text-[10px] font-black tracking-[0.3em] uppercase -mt-1">
                  Left
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 w-full gap-4 pt-4">
              <div className="text-center">
                <p className="text-zinc-500 text-[9px] font-black tracking-widest mb-1">
                  PROTEIN
                </p>
      ...
      <section className="space-y-6">
        <div className="flex items-end justify-between px-2">
          ...
          <p className="text-purple-600 font-bold text-xs uppercase tracking-widest">
            Total: {Math.round(consumed)}
          </p>
        </div>
        ...
        <div className="space-y-3">
          {logs.length === 0 ? (
            ...
            logs.map((log) => (
              <div
                key={log.id}
                className="bg-white p-6 rounded-[32px] border border-zinc-50 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex items-center justify-between tap-effect active:scale-[0.98] transition-all"
              >
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h4 className="font-black text-zinc-900 text-lg leading-none mb-1.5">
                      {log.food_name}
                    </h4>
